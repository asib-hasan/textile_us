...
<head>
  ...
  <title>Knit Wear Manufacturing - TexTileus</title>
  ...
  <main class="main">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Knit Wear Manufacturing</li>
          </ol>
        </div>
      </nav>
    </div>
    ...
    <section id="courses-course-details" class="courses-course-details section">
        <div class="container" data-aos="fade-up">
          <div class="row">
            <div class="col-lg-8">
              <img src="{{asset('frontend/course_img/banner-knit.jpg')}}" class="img-fluid" alt="">
              <h2 class="mb-2 mt-3" style="font-weight: bold;">Knit Wear Manufacturing</h2>
              <p style="text-align: justify;">The Knitwear Manufacturing Course aims to provide students with a solid foundation in the design, production, and quality control of knitwear garments. The course will cover fundamental knitting techniques, machine operation, fabric properties, pattern making, and sustainability practices.</p>
            </div>
            <div class="col-lg-4">
              <div class="member-img text-center mb-3">
                <img src="{{asset('frontend/teachers/fahad.jpeg')}}" height="200px" style="border:2px solid #5799FE; border-radius: 50%;" alt="">
              </div>
        ...
        <div class="container">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td>KM101</td>
                <td>Basics in Knit Wear Manufacturing</td>
                <td>3</td>
              </tr>
              <tr>
                <td>KM102</td>
              ...
              <tr>
                <td>KM103</td>
                <td>Knit Wear Manufacturing Machineries and Maintenance</td>
                <td>3</td>
              </tr>
              <tr>
                <td>KM104</td>
              ...
              <tr>
                <td>KM105</td>
                <td>Compliance in Knit Industry</td>
                <td>3</td>
              </tr>
            </tbody>
          </table>
            ...
            <div class="accordion" id="courseAccordion">
                ...
                <div class="card-header" id="headingOne">
                  <h5 class="mb-0">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                      KM101: Basics in Knit Wear Manufacturing (3 Credits) <span class="accordion-icon">&#9660;</span>
                    </button>
                  </h5>
                </div>
              ...
              <div class="card">
                <div class="card-header" id="headingThree">
                  <h5 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                      KM103: Knit Wear Manufacturing Machineries and Maintenance (3 Credits) <span class="accordion-icon">&#9660;</span>
                    </button>
                  </h5>
                </div>
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#courseAccordion">
                  <div class="card-body">
                    <ul>
                      <li>Maintenance of the single jersey knitting machine</li>
                      <li>Maintenance of different knitting machines</li>
                      <li>Circular rib machine</li>
                      <li>Interlock Machine</li>
                      <li>Purl Machine</li>
                      <li>Hosiery Machines</li>
                      <li>Weft Knitting Machines</li>
                ...
                <div class="card-header" id="headingFive">
                  <h5 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                      KM105: Compliance in Knit Industry (3 Credits) <span class="accordion-icon">&#9660;</span>
                    </button>
                  </h5>
                </div>
